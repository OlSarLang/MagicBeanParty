...
/**
 * A simple window to draw in, used in "Objektorienterad programmering
 * och Java".
 *
 ...
 *		SimpleWindow2
 *	---!!!OBSESRVERA!!!---
 *Denna SimpleWindows skiljer sig ifrån SimpleWindows orginal, se rad 213, 244, 249 och 269.
 *
 */
public class SimpleWindow {
	...
	public void waitForMouseClick() {
		do {
			waitForEvent();
		} while (getEventType() != MOUSE_EVENT);			//Ändrat
	}
	...
	public void waitForEvent() {
		...
		try {
			lastEvent = eventQueue.poll(100, TimeUnit.MILLISECONDS);	//Väntar 100 ms på händelse annars null
